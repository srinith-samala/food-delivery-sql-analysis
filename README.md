Food Delivery Data Analysis (SQL Project) 📌 Project Overview

This project analyzes a food delivery dataset using SQL to uncover insights about customers, restaurants, orders, and revenue trends. The goal of the project is to simulate real-world data analyst work, focusing on writing efficient SQL queries and deriving business insights.
